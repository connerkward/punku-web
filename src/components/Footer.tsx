...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="footer" id="contact">
      {/* Top stripe of microbars + technical labels */}
      ...
      <div className="footer__grid">
        <section className="footer__form-block">
          <header className="footer__block-header">
            ...
            <span className="footer__block-id tech">FORM PNK—04 · REV B</span>
          </header>
          <ContactForm />
        </section>
        ...
        <aside className="footer__meta-block">
          ...
          <div className="footer__cert-grid">
            <div className="footer__cert">
              <CEIcon size={36} stroke="#0a0a0a" strokeWidth={1.6} />
      ...
      <div className="footer__brand">
        ...
        <div className="footer__sig">
          <div className="footer__sig-row tech">STUDIO {" "}<span className="amp">&amp;</span>{" "} FIELD LAB · ©2026</div>
          ...
          <div className="footer__sig-row tech">ALL RIGHTS RESERVED</div>
        </div>
      </div>

      <div className="footer__base tech" aria-hidden="true">
        <span>PNK—2026—042 · D</span>
        <span className="footer__base-mid">
          <span className="footer__base-bar" />
          <span className="footer__base-bar footer__base-bar--mid" />
          <span className="footer__base-bar" />
        </span>
